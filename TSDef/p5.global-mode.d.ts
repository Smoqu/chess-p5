 ...
 *   @param key or object
 */
declare function createStringDict(
  key: string | object,
  value: string
): p5.StringDict;
 ...
 *   @param key or object
 */
declare function createNumberDict(
  key: number | object,
  value: number
): p5.NumberDict;
 ...
 *   to right across each column, then down each column.
 ...
 *   Table only looks for a header column if the 'header'
 *   option is included. Possible options include:
 *
 *   - csv - parse the table as comma-separated values
 *   - tsv - parse the table as tab-separated values
 *   - header - this table has a header (title) column
 *
